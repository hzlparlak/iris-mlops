...
def train_with_mlflow():
    """MLflow ile Iris veri setinde model eğitimi ve takip"""
    
    # İşlenmiş veriyi yükle
    df = pd.read_csv("../data/processed/iris_processed.csv")  # src klasöründen çalıştırıyorsan ../ kullan
...
if __name__ == "__main__":
    print("🚀 MLflow ile Iris model eğitimine başlıyor...")
